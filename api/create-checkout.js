...
const PLANS = {
  ...
  'supermatrix-5': {
    name: 'SuperMatrix 5.5',
    description: 'Most powerful model — SuperMatrix 5.5. Unlimited messages, deep reasoning, priority processing.',
    amount: 1900, // $19.00
    currency: 'usd',
    interval: 'month',
    features: {
      messagesPerDay: -1,
      models: ['supermatrix-5.5', 'gpt-4o', 'claude-3-5-sonnet', 'gpt-4-turbo'],
      imageGenPerDay: -1,
      webSearch: true,
      memoryPersistence: true,
      priorityRouting: true,
